...
/* Animated GIF background for the Clock app (/clock/gif/bg.gif), sized for a full
...
#define CLOCK_GIF_NO_FILE  1   /* /clock/gif/bg.gif missing or unreadable */
...
void clock_gif_reserve(void);                    /* at boot, before covers: pre-claim
                                                    ...
                                                    pool per /clock/gif/bg.gif's header */
void clock_gif_set_file(const char *name);       /* basename under /clock/gif; NULL/"" = bg.gif */
