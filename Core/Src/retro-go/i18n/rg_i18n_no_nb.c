...
const lang_t lang_no_nb LANG_DATA = {
    ...
    .s_Clock_Timer = "NEDTELLING",
    .s_Clock_Stopwatch = "STOPPEKLOKKE",
    .s_Clock_Work = "ARBEID",
    .s_Clock_Break = "HVILE",
    .s_Clock_Cycle = "runde",
    .s_Clock_Ringing = "* ALARM *",
    .s_Clock_Hint_Clock = "L/R modus  PAUSE innstillinger/avslutt",
    .s_Clock_Hint_Run = "A pause  B nullstill",
    .s_Clock_Hint_Stop = "A start  B nullstill",
    .s_Clock_Hint_TimerStop = "A start  B nullstill  UP/DN min",
    .s_Clock_Hint_Editor = "A rediger/ny  TIME på/av  GAME slett  B ferdig",
    .s_Clock_Hint_Edit = "L/R felt  UP/DN juster  A ok  B avbryt",
    .s_Clock_Add_Alarm = "Legg til alarm",
    .s_Clock_Done = "Ferdig",
    .s_Clock_On = "På",
    .s_Clock_Off = "Av",
    .s_Clock_Format = "Tidsformat",
    .s_Clock_DND = "Ikke forstyrr",
    .s_Clock_Anim = "Bakgrunn",
    .s_Clock_Anim_0 = "Av (ingen kostnad)",
    .s_Clock_Anim_1 = "Ambient (lav)",
    .s_Clock_Anim_2 = "GIF (høy)",
    .s_Clock_Volume = "Alarmvolum",
    .s_Clock_Alarms = "Alarmer",
    .s_Clock_Exit = "Avslutt klokken",
    .s_Sort = "Sorter",
