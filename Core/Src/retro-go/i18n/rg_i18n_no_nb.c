...
const lang_t lang_no_nb LANG_DATA = {
    ...
    .s_Reset_favorites = "Tilbakestill favoritter",
    .s_Clock = "Klokke",
    .s_AM = "AM",
    .s_PM = "PM",
    ...
    .s_Clock_Anim_0 = "Strømsparing",
    .s_Clock_Set_Time = "Still klokken",
    .s_Clock_Scene = "Scene",
    .s_Clock_Photo_Speed = "Bildefart",
    .s_Clock_Speed_Slow = "Sakte",
    .s_Clock_Speed_Normal = "Normal",
    .s_Clock_Speed_Fast = "Rask",
    ...
    .s_Sort = "Sorter",
    .s_Sort_name = "Etter navn",
    .s_Sort_added = "Etter lagt til",
