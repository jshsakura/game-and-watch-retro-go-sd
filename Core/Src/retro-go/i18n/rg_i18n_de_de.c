...
const lang_t lang_de_de LANG_DATA = {
    ...
    .s_Reset_favorites = "Favoriten zurücksetzen",
    .s_Clock = "Uhr",
    .s_AM = "AM",
    .s_PM = "PM",
    .s_Clock_Pomodoro = "POMODORO",
    .s_Clock_Timer = "TIMER",
    .s_Clock_Stopwatch = "STOPWATCH",
    .s_Clock_Work = "WORK",
    .s_Clock_Break = "BREAK",
    .s_Clock_Cycle = "round",
    .s_Clock_Ringing = "ALARM!",
    .s_Clock_Hint_Clock = "PAUSE settings",
    .s_Clock_Hint_Run = "A start/stop  B reset",
    .s_Clock_Hint_Stop = "A start/stop  B reset",
    .s_Clock_Hint_TimerStop = "A start/stop  B reset  Up/Dn min",
    .s_Clock_Hint_Editor = "A edit  TIME on/off  GAME del  B done",
    .s_Clock_Hint_Edit = "L/R field  Up/Dn set  A ok  GAME del  B cancel",
    .s_Clock_Add_Alarm = "Add alarm",
    .s_Clock_Done = "Done",
    .s_Clock_On = "On",
    .s_Clock_Off = "Off",
    .s_Clock_Format = "Time format",
    .s_Clock_DND = "Do Not Disturb",
    .s_Clock_Anim = "Background",
    .s_Clock_Anim_0 = "Energiesparen",
    .s_Clock_Set_Time = "Uhrzeit stellen",
    .s_Clock_Scene = "Pixel-Stil",
    .s_Clock_Photo_Speed = "Tempo",
    .s_Clock_Anim_4 = "Fotoalbum",
    .s_Clock_Keep_Awake = "Wach bleiben",
    .s_Clock_Bg_File = "GIF",
    .s_Clock_Alarm_Sound = "Alarmton",
    .s_Clock_Night_Off = "Aus-Zeit Start",
    .s_Clock_Night_End = "Aus-Zeit Ende",
    .s_Clock_Snd_Preview = "GAME: Vorhören",
    .s_Speed_Slow = "Langsam",
    .s_Speed_Normal = "Normal",
    .s_Speed_Fast = "Schnell",
    .s_Clock_Anim_1 = "Ambient (low)",
    .s_Clock_Anim_2 = "Pixel-BG",
    .s_Clock_Volume = "Alarm volume",
    .s_Clock_Alarms = "Alarms",
    .s_Clock_Exit = "Exit clock",
    .s_Clock_Hint_Ring = "A snooze 5min  B stop",
    .s_Clock_Theme = "Theme",
    .s_Clock_Face = "Digit face",
    .s_Clock_Auto = "Auto",
    .s_Clock_Anim_3 = "GIF",
    .s_repeat = "Wiederholen",
    .s_shuffle = "Zufall",
    ...
    .s_Sort = "Sortieren",
    .s_Sort_name = "Nach Name",
    .s_Sort_added = "Nach Zugang",
    ...
    .s_media_hint = "A:Öffnen  B:Zurück",
    .s_media_empty = "(leer)",
