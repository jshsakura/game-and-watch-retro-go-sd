...
const lang_t lang_de_de LANG_DATA = {
    ...
    .s_Clock_Hint_Edit = "L/R field  Up/Dn set  A ok  B cancel",
    ...
    .s_Clock_Speed_Slow = "Langsam",
    .s_Clock_Speed_Normal = "Normal",
    .s_Clock_Speed_Fast = "Schnell",
    .s_Clock_Anim_4 = "Fotoalbum",
    .s_Clock_Anim_1 = "Ambient (low)",
    .s_Clock_Anim_2 = "Pixel scene (low)",
