...
const lang_t lang_de_de LANG_DATA = {
    ...
    .s_Clock_Timer = "TIMER",
    .s_Clock_Stopwatch = "STOPPUHR",
    .s_Clock_Work = "ARBEIT",
    .s_Clock_Break = "AUSZEIT",
    .s_Clock_Cycle = "Runde",
    .s_Clock_Ringing = "* ALARM *",
    .s_Clock_Hint_Clock = "L/R Modus  PAUSE Menü/Beenden",
    .s_Clock_Hint_Run = "A Pause  B Reset",
    .s_Clock_Hint_Stop = "A Start  B Reset",
    .s_Clock_Hint_TimerStop = "A Start  B Reset  UP/DN Min",
    .s_Clock_Hint_Editor = "A ändern/neu  TIME an/aus  GAME löschen  B fertig",
    .s_Clock_Hint_Edit = "L/R Feld  UP/DN einstellen  A ok  B abbrechen",
    .s_Clock_Add_Alarm = "Alarm hinzufügen",
    .s_Clock_Done = "Fertig",
    .s_Clock_On = "An",
    .s_Clock_Off = "Aus",
    .s_Clock_Format = "Zeitformat",
    .s_Clock_DND = "Nicht stören",
    .s_Clock_Anim = "Hintergrund",
    .s_Clock_Anim_0 = "Aus (kein Verbrauch)",
    .s_Clock_Anim_1 = "Ambiente (gering)",
    .s_Clock_Anim_2 = "GIF (hoch)",
    .s_Clock_Volume = "Alarmlautstärke",
    .s_Clock_Alarms = "Alarme",
    .s_Clock_Exit = "Uhr beenden",
