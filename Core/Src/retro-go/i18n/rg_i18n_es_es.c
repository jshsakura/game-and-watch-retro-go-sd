...
const lang_t lang_es_es LANG_DATA = {
    ...
    .s_Clock_Work = "TRABAJO",
    .s_Clock_Break = "DESCANSO",
    .s_Clock_Cycle = "ronda",
    .s_Clock_Ringing = "* ALARMA *",
    .s_Clock_Hint_Clock = "L/R modo  PAUSE ajustes/salir",
    .s_Clock_Hint_Run = "A pausa  B reiniciar",
    .s_Clock_Hint_Stop = "A iniciar  B reiniciar",
    .s_Clock_Hint_TimerStop = "A iniciar  B reiniciar  UP/DN min",
    .s_Clock_Hint_Editor = "A editar/añadir  TIME on/off  GAME borrar  B hecho",
    .s_Clock_Hint_Edit = "L/R campo  UP/DN ajustar  A ok  B cancelar",
    .s_Clock_Add_Alarm = "Añadir alarma",
    .s_Clock_Done = "Hecho",
    .s_Clock_On = "On",
    .s_Clock_Off = "Off",
    .s_Clock_Format = "Formato de hora",
    .s_Clock_DND = "No molestar",
    .s_Clock_Anim = "Fondo",
    .s_Clock_Anim_0 = "Apagado (sin gasto)",
    .s_Clock_Anim_1 = "Ambiente (bajo)",
    .s_Clock_Anim_2 = "GIF (alto)",
    .s_Clock_Volume = "Volumen de alarma",
    .s_Clock_Alarms = "Alarmas",
    .s_Clock_Exit = "Salir del reloj",
    .s_repeat = "Repetir",
    .s_shuffle = "Aleatorio",
    .s_brightness = "Brillo",
    .s_info = "Info",
