...
const lang_t lang_es_es LANG_DATA = {
    ...
    .s_Reset_favorites = "Restablecer favoritos",
    .s_Clock = "Reloj",
    .s_AM = "a.m.",
    .s_PM = "p.m.",
    ...
    .s_Clock_Anim_0 = "Ahorro",
    .s_Clock_Set_Time = "Ajustar hora",
    .s_Clock_Scene = "Escena",
    .s_Clock_Photo_Speed = "Velocidad foto",
    .s_Clock_Speed_Slow = "Lento",
    .s_Clock_Speed_Normal = "Normal",
    .s_Clock_Speed_Fast = "Rápido",
    ...
    .s_Sort = "Ordenar",
    .s_Sort_name = "Por nombre",
    .s_Sort_added = "Por añadido",
