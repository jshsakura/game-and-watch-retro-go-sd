...
const lang_t lang_it_it LANG_DATA = {
    ...
    .s_Clock_Timer = "TIMER",
    .s_Clock_Stopwatch = "CRONOMETRO",
    .s_Clock_Work = "LAVORO",
    .s_Clock_Break = "RIPOSO",
    .s_Clock_Cycle = "ciclo",
    .s_Clock_Ringing = "* SVEGLIA *",
    .s_Clock_Hint_Clock = "L/R modo  PAUSE opzioni/uscita",
    .s_Clock_Hint_Run = "A pausa  B azzera",
    .s_Clock_Hint_Stop = "A avvia  B azzera",
    .s_Clock_Hint_TimerStop = "A avvia  B azzera  UP/DN min",
    .s_Clock_Hint_Editor = "A modifica/nuova  TIME on/off  GAME elimina  B fine",
    .s_Clock_Hint_Edit = "L/R campo  UP/DN regola  A ok  B annulla",
    .s_Clock_Add_Alarm = "Aggiungi sveglia",
    .s_Clock_Done = "Fatto",
    .s_Clock_On = "On",
    .s_Clock_Off = "Off",
    .s_Clock_Format = "Formato ora",
    .s_Clock_DND = "Non disturbare",
    .s_Clock_Anim = "Sfondo",
    .s_Clock_Anim_0 = "Spento (nessun consumo)",
    .s_Clock_Anim_1 = "Ambiente (basso)",
    .s_Clock_Anim_2 = "GIF (alto)",
    .s_Clock_Volume = "Volume sveglia",
    .s_Clock_Alarms = "Sveglie",
    .s_Clock_Exit = "Esci dall'orologio",
    .s_repeat = "Ripeti",
    .s_shuffle = "Casuale",
