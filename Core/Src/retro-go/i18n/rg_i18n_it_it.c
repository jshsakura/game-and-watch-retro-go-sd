...
const lang_t lang_it_it LANG_DATA = {
    ...
    .s_Reset_favorites = "Azzera i preferiti",
    .s_Clock = "Orologio",
    .s_AM = "AM",
    .s_PM = "PM",
    ...
    .s_Clock_Anim_0 = "Risparmio",
    .s_Clock_Set_Time = "Imposta ora",
    .s_Clock_Scene = "Stile pixel",
    .s_Clock_Photo_Speed = "Vel. foto",
    .s_Clock_Anim_4 = "Album foto",
    .s_Clock_Keep_Awake = "Sempre acceso",
    .s_Clock_Bg_File = "GIF",
    .s_Clock_Alarm_Sound = "Suono allarme",
    .s_Clock_Night_Off = "Spegnim. inizio",
    .s_Clock_Night_End = "Spegnim. fine",
    .s_Clock_Snd_Preview = "GAME: ascolta",
    .s_Speed_Slow = "Lenta",
    .s_Speed_Normal = "Normale",
    .s_Speed_Fast = "Rapida",
    .s_Clock_Anim_1 = "Ambient (low)",
    .s_Clock_Anim_2 = "Sfondo pixel",
    ...
    .s_Sort = "Ordina",
    .s_Sort_name = "Per nome",
    .s_Sort_added = "Per aggiunta",
