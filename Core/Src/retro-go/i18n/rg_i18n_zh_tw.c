...
const lang_t lang_zh_tw LANG_DATA = {
    ...
    .s_AM = "上午",
    .s_PM = "下午",
    .s_Clock_Pomodoro = "番茄鐘",
    .s_Clock_Timer = "計時器",
    .s_Clock_Stopwatch = "碼錶",
    .s_Clock_Work = "專注",
    .s_Clock_Break = "休息",
    .s_Clock_Cycle = "回合",
    .s_Clock_Ringing = "* 鬧鐘 *",
    .s_Clock_Hint_Clock = "L/R 模式  PAUSE 設定/離開",
    .s_Clock_Hint_Run = "A 暫停  B 重置",
    .s_Clock_Hint_Stop = "A 開始  B 重置",
    .s_Clock_Hint_TimerStop = "A 開始  B 重置  UP/DN 分鐘",
    .s_Clock_Hint_Editor = "A 編輯/新增  TIME 開/關  GAME 刪除  B 完成",
    .s_Clock_Hint_Edit = "L/R 位  UP/DN 調整  A 確定  B 取消",
    .s_Clock_Add_Alarm = "新增鬧鐘",
    .s_Clock_Done = "完成",
    .s_Clock_On = "開",
    .s_Clock_Off = "關",
    .s_Clock_Format = "時間格式",
