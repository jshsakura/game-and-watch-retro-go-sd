...
const lang_t lang_zh_cn LANG_DATA = {
    ...
    .s_Clock_Anim_0 = "省电",
    .s_Clock_Set_Time = "设置时间",
    .s_Clock_Scene = "像素样式",
    .s_Clock_Photo_Speed = "切换速度",
    .s_Clock_Anim_4 = "相册",
    .s_Clock_Keep_Awake = "屏幕常亮",
    .s_Clock_Bg_File = "GIF",
    .s_Clock_Alarm_Sound = "闹钟声音",
    .s_Clock_Night_Off = "熄屏 开始",
    .s_Clock_Night_End = "熄屏 结束",
    .s_Clock_Snd_Preview = "GAME: 试听",
    .s_Speed_Slow = "慢",
    .s_Speed_Normal = "正常",
    .s_Speed_Fast = "快",
