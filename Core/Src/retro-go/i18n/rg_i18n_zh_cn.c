...
const lang_t lang_zh_cn LANG_DATA = {
    ...
    .s_AM = "上午",
    .s_PM = "下午",
    .s_Clock_Pomodoro = "番茄钟",
    .s_Clock_Timer = "计时器",
    .s_Clock_Stopwatch = "秒表",
    .s_Clock_Work = "专注",
    .s_Clock_Break = "休息",
    .s_Clock_Cycle = "回合",
    .s_Clock_Ringing = "* 闹钟 *",
    .s_Clock_Hint_Clock = "L/R 模式  PAUSE 设置/退出",
    .s_Clock_Hint_Run = "A 暂停  B 重置",
    .s_Clock_Hint_Stop = "A 开始  B 重置",
    .s_Clock_Hint_TimerStop = "A 开始  B 重置  UP/DN 分钟",
    .s_Clock_Hint_Editor = "A 编辑/添加  TIME 开/关  GAME 删除  B 完成",
    .s_Clock_Hint_Edit = "L/R 位  UP/DN 调整  A 确定  B 取消",
    .s_Clock_Add_Alarm = "添加闹钟",
    .s_Clock_Done = "完成",
    .s_Clock_On = "开",
    .s_Clock_Off = "关",
    .s_Clock_Format = "时间格式",
