...
const lang_t lang_en_us LANG_DATA = {
    ...
    .s_Reset_favorites = "Reset favorites",
    .s_Clock = "Clock",
    .s_AM = "AM",
    .s_PM = "PM",
    ...
    .s_Clock_Anim_0 = "Power save",
    .s_Clock_Set_Time = "Set time",
    .s_Clock_Scene = "Scene",
    .s_Clock_Photo_Speed = "Photo speed",
    .s_Clock_Speed_Slow = "Slow",
    .s_Clock_Speed_Normal = "Normal",
    .s_Clock_Speed_Fast = "Fast",
