...
const lang_t lang_fr_fr LANG_DATA = {
    ...
    .s_Clock_Timer = "MINUTEUR",
    .s_Clock_Stopwatch = "CHRONO",
    .s_Clock_Work = "TRAVAIL",
    .s_Clock_Break = "REPOS",
    .s_Clock_Cycle = "cycle",
    .s_Clock_Ringing = "* ALARME *",
    .s_Clock_Hint_Clock = "L/R mode  PAUSE réglages/quitter",
    .s_Clock_Hint_Run = "A pause  B réinit.",
    .s_Clock_Hint_Stop = "A démarrer  B réinit.",
    .s_Clock_Hint_TimerStop = "A démarrer  B réinit.  UP/DN min",
    .s_Clock_Hint_Editor = "A éditer/ajouter  TIME on/off  GAME supprimer  B fini",
    .s_Clock_Hint_Edit = "L/R champ  UP/DN régler  A ok  B annuler",
    .s_Clock_Add_Alarm = "Ajouter une alarme",
    .s_Clock_Done = "Terminé",
    .s_Clock_On = "On",
    .s_Clock_Off = "Off",
    .s_Clock_Format = "Format d'heure",
    .s_Clock_DND = "Ne pas déranger",
    .s_Clock_Anim = "Fond",
    .s_Clock_Anim_0 = "Éteint (aucun coût)",
    .s_Clock_Anim_1 = "Ambiance (faible)",
    .s_Clock_Anim_2 = "GIF (élevé)",
    .s_Clock_Volume = "Volume de l'alarme",
    .s_Clock_Alarms = "Alarmes",
    .s_Clock_Exit = "Quitter l'horloge",
    .s_repeat = "Répéter",
    .s_shuffle = "Aléatoire",
