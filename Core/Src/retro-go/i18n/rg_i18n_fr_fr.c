...
const lang_t lang_fr_fr LANG_DATA = {
    ...
    .s_Clock_Anim_0 = "Économie",
    .s_Clock_Set_Time = "Régler l'heure",
    .s_Clock_Scene = "Scène",
    .s_Clock_Photo_Speed = "Vitesse photo",
    .s_Clock_Speed_Slow = "Lent",
    .s_Clock_Speed_Normal = "Normal",
    .s_Clock_Speed_Fast = "Rapide",
    .s_Clock_Anim_4 = "Album photo",
