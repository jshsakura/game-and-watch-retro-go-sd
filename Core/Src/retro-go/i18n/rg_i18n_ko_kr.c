...
const lang_t lang_ko_kr LANG_DATA = {
    ...
    .s_AM = "오전",
    .s_PM = "오후",
    .s_Clock_Pomodoro = "뽀모도로",
    .s_Clock_Timer = "타이머",
    .s_Clock_Stopwatch = "스톱워치",
    .s_Clock_Work = "집중",
    .s_Clock_Break = "휴식",
    .s_Clock_Cycle = "라운드",
    .s_Clock_Ringing = "알람!",
    ...
    .s_Clock_Add_Alarm = "알람 추가",
    .s_Clock_Done = "완료",
    .s_Clock_On = "켬",
    .s_Clock_Off = "끔",
    .s_Clock_Format = "시간 형식",
    .s_Clock_DND = "방해 금지",
    .s_Clock_Anim = "배경 효과",
    .s_Clock_Anim_0 = "절전",
    .s_Clock_Set_Time = "시간 설정",
    .s_Clock_Scene = "씬",
    .s_Clock_Photo_Speed = "사진 속도",
    .s_Clock_Speed_Slow = "느림",
    .s_Clock_Speed_Normal = "보통",
    .s_Clock_Speed_Fast = "빠름",
    .s_Clock_Anim_4 = "사진 앨범",
    .s_Clock_Anim_1 = "은은한 효과 (낮음)",
    .s_Clock_Anim_2 = "픽셀 풍경 (낮음)",
    .s_Clock_Volume = "알람 음량",
    .s_Clock_Alarms = "알람",
    .s_Clock_Exit = "시계 나가기",
    .s_Clock_Hint_Ring = "A 5분 스누즈  B 끄기",
    .s_Clock_Theme = "테마",
    .s_Clock_Face = "숫자 서체",
    .s_Clock_Auto = "자동",
    .s_Clock_Anim_3 = "GIF (높음)",
    .s_repeat = "반복",
    .s_shuffle = "셔플",
    .s_brightness = "밝기",
    .s_info = "정보",
