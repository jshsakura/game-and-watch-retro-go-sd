...
const lang_t lang_ru_ru LANG_DATA = {
    ...
    .s_Clock_Anim_0 = "Экономия",
    .s_Clock_Set_Time = "Установить время",
    .s_Clock_Scene = "Сцена",
    .s_Clock_Photo_Speed = "Скорость фото",
    .s_Clock_Speed_Slow = "Медл.",
    .s_Clock_Speed_Normal = "Норм.",
    .s_Clock_Speed_Fast = "Быстро",
    ...
    .s_Sort = "Сортировка",
    .s_Sort_name = "По имени",
    .s_Sort_added = "По добавлению",
