...
const lang_t lang_ru_ru LANG_DATA = {
    ...
    .s_AM = "AM",
    .s_PM = "PM",
    .s_Clock_Pomodoro = "ПОМИДОР",
    .s_Clock_Timer = "ТАЙМЕР",
    .s_Clock_Stopwatch = "СЕКУНДОМЕР",
    .s_Clock_Work = "РАБОТА",
    .s_Clock_Break = "ОТДЫХ",
    .s_Clock_Cycle = "раунд",
    .s_Clock_Ringing = "* БУДИЛЬНИК *",
    .s_Clock_Hint_Clock = "L/R режим  PAUSE настройки/выход",
    .s_Clock_Hint_Run = "A пауза  B сброс",
    .s_Clock_Hint_Stop = "A старт  B сброс",
    .s_Clock_Hint_TimerStop = "A старт  B сброс  UP/DN мин",
    .s_Clock_Hint_Editor = "A изменить  TIME вкл/выкл  GAME удалить  B готово",
    .s_Clock_Hint_Edit = "L/R поле  UP/DN настроить  A ок  B отмена",
    .s_Clock_Add_Alarm = "Добавить будильник",
    .s_Clock_Done = "Готово",
    .s_Clock_On = "Вкл",
    .s_Clock_Off = "Выкл",
    .s_Clock_Format = "Формат времени",
    .s_Clock_DND = "Не беспокоить",
    .s_Clock_Anim = "Фон",
    .s_Clock_Anim_0 = "Выкл (без расхода)",
    .s_Clock_Anim_1 = "Мерцание (низкий)",
    .s_Clock_Anim_2 = "GIF (высокий)",
    .s_Clock_Volume = "Громкость будильника",
    .s_Clock_Alarms = "Будильники",
    .s_Clock_Exit = "Выйти из часов",
    .s_repeat = "Повтор",
    .s_shuffle = "Случайно",
