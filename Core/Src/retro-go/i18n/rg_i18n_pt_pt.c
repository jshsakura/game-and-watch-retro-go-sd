...
const lang_t lang_pt_pt LANG_DATA = {
    ...
    .s_Clock_Timer = "TEMPORIZADOR",
    .s_Clock_Stopwatch = "CRONÓMETRO",
    .s_Clock_Work = "TRABALHO",
    .s_Clock_Break = "DESCANSO",
    .s_Clock_Cycle = "ciclo",
    .s_Clock_Ringing = "* ALARME *",
    .s_Clock_Hint_Clock = "L/R modo  PAUSE opções/sair",
    .s_Clock_Hint_Run = "A pausa  B repor",
    .s_Clock_Hint_Stop = "A iniciar  B repor",
    .s_Clock_Hint_TimerStop = "A iniciar  B repor  UP/DN min",
    .s_Clock_Hint_Editor = "A editar/novo  TIME on/off  GAME apagar  B feito",
    .s_Clock_Hint_Edit = "L/R campo  UP/DN ajustar  A ok  B cancelar",
    .s_Clock_Add_Alarm = "Adicionar alarme",
    .s_Clock_Done = "Feito",
    .s_Clock_On = "On",
    .s_Clock_Off = "Off",
    .s_Clock_Format = "Formato da hora",
    .s_Clock_DND = "Não incomodar",
    .s_Clock_Anim = "Fundo",
    .s_Clock_Anim_0 = "Desligado (sem gasto)",
    .s_Clock_Anim_1 = "Ambiente (baixo)",
    .s_Clock_Anim_2 = "GIF (alto)",
    .s_Clock_Volume = "Volume do alarme",
    .s_Clock_Alarms = "Alarmes",
    .s_Clock_Exit = "Sair do relógio",
    .s_repeat = "Repetir",
    .s_shuffle = "Aleatório",
    .s_brightness = "Brilho",
    .s_info = "Info",
