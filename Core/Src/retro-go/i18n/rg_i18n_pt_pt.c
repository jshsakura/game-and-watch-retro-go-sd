...
const lang_t lang_pt_pt LANG_DATA = {
    ...
    .s_Reset_favorites = "Repor favoritos",
    .s_Clock = "Relógio",
    .s_AM = "AM",
    .s_PM = "PM",
    ...
    .s_Clock_Anim_0 = "Poupança",
    .s_Clock_Set_Time = "Acertar hora",
    .s_Clock_Scene = "Estilo pixel",
    .s_Clock_Photo_Speed = "Vel. foto",
    .s_Clock_Anim_4 = "Álbum de fotos",
    .s_Clock_Auto_Dim = "Escurecer auto",
    .s_Clock_Bg_File = "GIF",
    .s_Clock_Alarm_Sound = "Som do alarme",
    .s_Clock_Night_Off = "Desligar: início",
    .s_Clock_Night_End = "Desligar: fim",
    .s_Clock_Snd_Preview = "GAME: ouvir",
    .s_Speed_Slow = "Lenta",
    .s_Speed_Normal = "Normal",
    .s_Speed_Fast = "Rápida",
    .s_Clock_Anim_1 = "Ambient (low)",
    .s_Clock_Anim_2 = "Fundo pixel",
    ...
    .s_Sort = "Ordenar",
    .s_Sort_name = "Por nome",
    .s_Sort_added = "Por adição",
