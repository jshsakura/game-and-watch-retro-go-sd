...
const lang_t lang_ja_jp LANG_DATA = {
    ...
    .s_AM = "午前",
    .s_PM = "午後",
    .s_Clock_Pomodoro = "ポモドーロ",
    .s_Clock_Timer = "タイマー",
    .s_Clock_Stopwatch = "ストップウォッチ",
    .s_Clock_Work = "作業",
    .s_Clock_Break = "休憩",
    .s_Clock_Cycle = "ラウンド",
    .s_Clock_Ringing = "* アラーム *",
    .s_Clock_Hint_Clock = "L/R モード  PAUSE 設定/終了",
    .s_Clock_Hint_Run = "A 一時停止  B リセット",
    .s_Clock_Hint_Stop = "A 開始  B リセット",
    .s_Clock_Hint_TimerStop = "A 開始  B リセット  UP/DN 分",
    .s_Clock_Hint_Editor = "A 編集/追加  TIME オン/オフ  GAME 削除  B 完了",
    .s_Clock_Hint_Edit = "L/R 桁  UP/DN 調整  A 決定  B キャンセル",
    .s_Clock_Add_Alarm = "アラーム追加",
    .s_Clock_Done = "完了",
    .s_Clock_On = "オン",
    .s_Clock_Off = "オフ",
    .s_Clock_Format = "時刻表示",
    .s_Clock_DND = "おやすみモード",
    .s_Clock_Anim = "背景",
    .s_Clock_Anim_0 = "オフ (消費なし)",
    .s_Clock_Anim_1 = "アンビエント (低)",
    .s_Clock_Anim_2 = "GIF (高)",
    .s_Clock_Volume = "アラーム音量",
    .s_Clock_Alarms = "アラーム",
    .s_Clock_Exit = "時計を終了",
    .s_repeat = "リピート",
    .s_shuffle = "シャッフル",
