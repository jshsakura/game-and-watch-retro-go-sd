/* nhdoom DEVICE port: replaces src/pwm_audio.c + Doom/source/i_audio.c.
 * Audio is a no-op for now (Phase 2 milestone is the firmware build); the API
 * is satisfied and the per-channel bookkeeping s_sound.c reads back is kept.
 *
