/* gifdec — minimal GIF decoder by Marcel Rodrigues (lecram), MIT License.
 * Source: https://github.com/lecram/gifdec  (vendored verbatim)
 * Used by the Clock app for animated (.gif) backgrounds. */
