...
void I_FinishUpdate (void)
{
     ...
     * (main_doom.c) reads I_VideoBuffer + doom_pal565 and blits RGB565 to the
     * LCD directly. cmap_to_fb / cmap_to_rgb565 are kept (unused) to minimise
     * the diff against the upstream file. */
    DG_DrawFrame();
}
