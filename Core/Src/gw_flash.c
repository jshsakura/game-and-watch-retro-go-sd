...
const jedec_config_t jedec_map[] = {
    ...
    JEDEC_CONFIG_DEF(0xC2, 0x20, 0x18, "MX25L12873",  &config_quad_24b_mx),   // 16 MB, 3.3v (require hardware mod to power 3.3v)
    ...
    JEDEC_CONFIG_DEF(0xC2, 0x20, 0x1A, "MX25L51245G",    &config_quad_32b_mx),   // 64 MB, 3.3v (require hardware mod to power 3.3v)
