/* Host-test stub. gw_audio.h is a COPY of Core/Inc/gw_audio.h (its "main.h"
 * include must resolve to the stub main.h here, not the device one) — keep
 * the audio API surface in sync if the real header changes. */
#ifndef _GW_AUDIO_H_
#define _GW_AUDIO_H_
