...
ssh "$REMOTE" "cd $RWORK && python3 tools/snes_survey/classify.py survey.tsv" > "$HERE/survey_summary.txt"

echo "[4/4] done -> tools/snes_survey/survey_summary.txt" >&2
echo "======================================================================"
cat "$HERE/survey_summary.txt"
