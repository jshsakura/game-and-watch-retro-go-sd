...
gcc -o "$O/dump" "$O"/{apu,cart,dma,dsp,input,ppu,snes,snes_other,spc,tracing,rc_dispatch}.o \
...
gcc -o "$O/baseline" "$O"/{apu,cart,dma,dsp,input,ppu,snes,snes_other,spc,tracing,rc_dispatch}.o \
...
gcc -o "$O/hybrid" "$O"/{apu,cart,dma,dsp,input,ppu,snes,snes_other,spc,tracing,rc_dispatch}.o \
