...
# (external/picodrive in-tree, -DGNW_32X_CORE -DEMU_F68K), so the Thumb
...
DEF="-DGNW_32X_CORE -DEMU_F68K -DTABLES_FULL -D_USE_CZ80 -DNDEBUG -DRIG_SH2_COUNT -DRIG_FRAMES=$FRAMES ${EXTRA_DEF:-}"
...
cpu/fame/famec.c cpu/cz80/cz80.c
