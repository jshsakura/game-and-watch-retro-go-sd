...
CF="-mcpu=cortex-m7 -mthumb -O1 -c -DTARGET_GNW -DGNW_SNES_CORE -Iexternal/sm/src -Iexternal/sm -ICore/Inc -w"
for f in apu cart cpu dma dsp input ppu snes snes_other spc; do
